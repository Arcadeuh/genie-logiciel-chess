...
public class BoardView extends JComponent {
	...
	private static final Shape HIGHLIGHT = new RoundRectangle2D.Double(HIGHLIGHT_PADDING, HIGHLIGHT_PADDING,
			TILE_SIZE - HIGHLIGHT_PADDING * 2, TILE_SIZE - HIGHLIGHT_PADDING * 2, (double)HIGHLIGHT_PADDING * 4,
	...
	public void updateSize(int width, int height) {
		setPreferredSize(new Dimension(PREF_SIZE * width, PREF_SIZE * height));
		setMinimumSize(new Dimension(MIN_SIZE * width, MIN_SIZE * height));
	}
