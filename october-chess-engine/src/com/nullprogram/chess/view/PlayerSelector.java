...
public class PlayerSelector extends JPanel {
	...
	private static final String[] LABELS_AI = { "Fool (2 plies)", "Very Easy (3 plies)", "Easy (4 plies)",
			"Medium (5 plies)", "Hard (6 plies)", "Harder (7 plies)", "Challenging (8 plies)" };
	...
	public PlayerSelector(final String title, final boolean humanSet) {
		...
		human.addActionListener(e -> ai.setEnabled(!human.isSelected()));
		minimax.addActionListener(e -> ai.setEnabled(minimax.isSelected()));
